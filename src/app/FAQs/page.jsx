...
function FAQPage() {
    ...
    return (
        <div className="p-8 max-w-screen-xl mx-2 xl:mx-auto px-2 items-center justify-center">
            <h1 className="text-2xl text-transparent mt-4 leading-normal bg-gradient-to-br from-blue-600 via-sky-500 to-green-500 bg-clip-text xl:text-3xl">Frequently Asked Questions</h1>
            <p className="mt-4 xl:w-10/12 text-lg">
